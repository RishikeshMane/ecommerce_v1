...
@Component({
  selector: 'app-ecommerce-privacypolicy',
  templateUrl: './ecommerce-privacypolicy.component.html',
  styleUrls: ['../app-bagwani.component.css'],
  ///standalone: true,
})

export class ECommercePrivacyPolicyComponent implements OnInit 
{
  privacyPolicyImageUrl: string = 'assets/eCommerce-Images/PrivacyPolicy/privacypolicy.jpg';
